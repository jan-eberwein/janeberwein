    ...
    <section className="w-full min-h-[80vh] flex flex-col justify-center items-center text-center relative pt-10">
      ...
      >
        ...
        <div className="flex items-center space-x-6 text-foreground/60">
          <a
            href="https://github.com/jan-eberwein"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-electric-blue hover:scale-110 transition-all"
            aria-label="GitHub"
          >
            <Github size={24} />
          </a>
          <a
            href="https://x.com/jan_eberwein"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-electric-blue hover:scale-110 transition-all"
            aria-label="X"
          ...
          <a
            href="https://www.instagram.com/jan.eberwein/"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-electric-blue hover:scale-110 transition-all"
          ...
          <a
            href="https://www.linkedin.com/in/jan-eberwein/"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-electric-blue hover:scale-110 transition-all"
            aria-label="LinkedIn"
          ...
          <a
            href="mailto:jan@janeberwein.at"
            className="hover:text-electric-blue hover:scale-110 transition-all"
            aria-label="Email"
          >
            <Mail size={24} />
