...
export function Instagram({ size = 24, className = "", ...props }: { size?: number | string; className?: string } & React.SVGProps<SVGSVGElement>) {
  return (
    <svg
...
export function Github({ size = 24, className = "", ...props }: { size?: number | string; className?: string } & React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
